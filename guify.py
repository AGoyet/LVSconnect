...
try:
    ...
    print(
        "Warning: tkinter could not be imported. Defaulting to console mode (no gui)."
    )
    guify_flag = False
    gui_available = False
...
def center_and_hide_window(win):
    ...
    win.geometry(
        "0x0+{}+{}".format(positionRight, positionDown)
    )  # Win does not move yet
